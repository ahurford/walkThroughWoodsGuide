...
1.  Review [7 Best Practices](https://ahurford.github.io/quant-guide-all-courses/style.html) chapter of [Quantitative skills for biology](https://ahurford.github.io/quant-guide-all-courses/). It is best to make a folder on your computer Desktop where you will work on this assignment and stay organized.

2.  Download the file `wood.csv` from the course BrightSpace.

3.  Review [8.2 Loading or importing data](https://ahurford.github.io/quant-guide-all-courses/data-entry.html#loading-or-importing-data). Open and save a new R Script (see [3.2 Source Pane](https://ahurford.github.io/quant-guide-all-courses/rstudio.html#source-pane%5D) if you are unsure how to do this). **TRY IT!** One of the first commands of your R Script will be to load your data, for example:
...
|   **The column names precisely as they appear in the output** of `names(data1)` or RStudio will produce
|   an error.

8.  **TRY IT!** Can you make a plot of different variables, for example, `Wood density` and `Average of the absolute value of latitude`?
