...
10. To analyze the relationship between variables we can use the `cor(x,y,method = "pearson")` function. See [Correlation](https://ahurford.github.io/quant-guide-all-courses/statistics.html#correlation) for details. Can you find the correlation coefficient for two variables in the `woods.csv` data set? If you plot these same two variables do you see a relationship?
