...
(Note `tail` gives the last 6 rows). If we have made a dataframe with the correct structure, then we can use the `boxplot` command to visualize the average cross sectional area for vessels of plants from the families `Rhamnaceae` and  `Fabaceae`.
