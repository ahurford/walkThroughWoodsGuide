...
A large number of vessels in a stem allows for a lot of water transport, but this leaves less space for fibres, which provide mechanical support (and vice versa). A stem with more vessels and less fibres would be weaker than a stem with less vessels and more fibres.

**Wood Density:**

Wood density is a function of the amount of different tissue types within the stem and is related to ecological and environmental factors. Wood density typically ranges from 0.1-1.2 $g/cm^{3}$ (the density of water is 1 $g/cm^{3}$). A stem with lots of vessels or large vessels would be less dense (as vessels are hollow) then a stem with little vessel tissue (because more fibers).
